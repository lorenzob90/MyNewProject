...
class ClockObject {
  ...
  startChrono (chrono,callback) {
    this.chronoId = chrono[0];
    this.chronoCallback = callback;
    clearInterval(chrono[0]);//Reset
    this.chronoCounter = 0;//Reset
    let self = this;
    this.chronoId = setInterval(function(e){ 
      self.chronoCounter++;
...
class GridViewObject extends __WEBPACK_IMPORTED_MODULE_0__base_object_base_object_module_js__["a" /* default */] {
  constructor() {
    ...
    this.setProperty = Object.assign(this.setProperty, {
      ...
      "height": (objName, value) => {
        if (objName == "GridViewCell") {
          ...
          $(ele).each(function(i) {
            ...
            $(this).css("left",value*(i));
          });
        }
      },
      "Horizontal separator thick": (objName, value) => {
        let ele = "[obj-name= \"" + objName + "\"]";
        $(ele).css("border-right-width",value+"px");
      },
      "Vertical separator thick": (objName, value) => {
        let ele = "[obj-name= \"" + objName + "\"]";
        $(ele).css("border-bottom-width",value+"px");
      },
      "separator color": (objName, value) => {
        let ele = "[obj-name= \"" + objName + "\"]";
        $(ele).css("border-color",value);
      },
      "Highlight cell color": (objName, value) => {
        let ele = "[obj-name= \"" + objName + "\"]";
        $(ele).attr("cell-highlight-color",value);
      ...
      "Highlight cell": (objName, value) => {
        let ele = "[obj-name= \"" + objName + "\"]";
        if (value) {
          $(ele).attr("cell-highlight","YES");
          $(ele).mouseenter(function() {
            $(this).css("background-color",$(ele).attr("cell-highlight-color"));
          }).mouseleave(function() {
            $(this).css("background-color",$(ele).attr("cell-bg-color"));
          });
        } else {
          $(ele).attr("cell-highlight","NO");
          $(ele).unbind("mouseenter");
        }
      },
      width: (obj, value) => {
      ...
      x: (obj, value) => {
        let ele = "[obj-name= \"" + obj + "\"]";
        //var yPos = Math.round(parseFloat(($(elem)[0].style.transform.split('(')[1].split(')')[0].split(','))[1], 10)); // elem.css('transform').split(',')[5])
        var yPos = ele.position().top;
        // remove constraints
        this.removeConstraints(ele, "x");
        ele.css("transform", "translate(" + value + "px," + yPos + "px)");
      },
      y: (obj, value) => {
        let ele = "[obj-name= \"" + obj + "\"]";
        //var xPos = Math.round(parseFloat(($(elem)[0].style.transform.split('(')[1].split(')')[0].split(','))[0], 10)); // elem.css('transform').split(',')[4])
        ...
        ele.css("transform", "translate(" + xPos + "px," + value + "px)");
      },
      Alpha: (obj, value) => {
        let ele = "[obj-name= \"" + obj + "\"]";
  ...
  configureCells (objName, cellLength) {
    ...
    for (let i=0;i<cellsTobeAdded;i++) {
      ...
      $(cellView).attr("gridindex", i+1);
      $(cellView).click( function() {
        // console.log("clicked ", $(this).attr("gridindex"));
        parent.setContext($(this));
        //callback here
        let callback = parent.clickCallbacks[$(this).attr("obj-name")];
        if( callback != null ) {
          callback($(this), $(this).attr("gridindex"));
        }
...
class NotificationObject {
    ...
    whenNotificationShown (callback) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_snapclinical__ = __webpack_require__(2);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__JavascriptDistLib_core_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__objects_label_label_module_js__ = __webpack_require__(24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__objects_button_button_module_js__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__objects_network_network_module_js__ = __webpack_require__(31);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__objects_json_json_module_js__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__objects_connio_connio_module_js__ = __webpack_require__(13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__objects_animation_animation_module_js__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__objects_screen_screen_module_js__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__objects_dictionary_dictionary_module_js__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__objects_textLibrary_textLibrary_module_js__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__objects_image_image_module_js__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__objects_imageLibrary_imageLibrary_module_js__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__objects_container_container_module_js__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__objects_location_location_module_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__objects_mathLibrary_mathLibrary_module_js__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__objects_lists_lists_module_js__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__objects_application_application_module_js__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__objects_graphview_graphview_module_js__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__objects_storage_storage_module_js__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__objects_gauge_gauge_module_js__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__objects_webview_webview_module_js__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__objects_colourLibrary_colourLibrary_module_js__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__objects_timeLibrary_timeLibrary_module_js__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__objects_mapview_mapview_module_js__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__objects_textbox_textbox_module_js__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__objects_slider_slider_module_js__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__objects_videoview_videoview_module_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__objects_videoLibrary_videoLibrary_module_js__ = __webpack_require__(45);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__objects_snapclinical_snapclinical_module_js__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__objects_dialog_dialog_module_js__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__objects_bluetooth_bluetooth_module_js__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__objects_gridview_gridview_module_js__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__objects_clock_clock_module_js__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__objects_listview_listview_module_js__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_34__objects_motion_motion_module_js__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__objects_notification_notification_module_js__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__objects_audioLibrary_audioLibrary_module_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__objects_smartdevices_smartdevices_module_js__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_38__objects_camera_camera_module_js__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__objects_cameraview_cameraview_module_js__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__objects_phone_phone_module_js__ = __webpack_require__(34);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__objects_widgetcanvas_widgetcanvas_module_js__ = __webpack_require__(48);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__objects_system_system_module_js__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__objects_pageview_pageview_module_js__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__objects_firebase_firebase_module_js__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__objects_qrcodescanner_qrcodescanner_module_js__ = __webpack_require__(35);
// ES6 imports
